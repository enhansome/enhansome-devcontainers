# Awesome Dev Containers with stars
...
* [vscli](https://github.com/michidk/vscli) ⭐ 459 | 🐛 4 | 🌐 Rust | 📅 2026-09-02 - A CLI/TUI which makes it easy to launch vscode projects from the terminal, with a focus on dev containers. Also supports projects with multiple dev containers.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-02 - Multi-cluster Kubernetes dashboard with AI-powered operations, real-time observability, and CNCF project integrations across edge and cloud clusters.
* [Devsy](https://github.com/devsy-org/devsy/) ⭐ 71 | 🐛 21 | 🌐 Go | 📅 2026-09-02 | [devsy.sh](https://devsy.sh/) - Accelerate engineering velocity with Devsy, a workspace management tool for deploying devcontainers on Docker, Kubernetes, cloud providers (e.g., AWS, GCP, Azure, and more), and SSH remote hosts.
...
* [aicontainer](https://github.com/stefanoginella/aicontainer) ⭐ 20 | 🐛 3 | 🌐 Shell | 📅 2026-09-01 - A CLI that drops a sandboxed dev container into any project for running AI coding agents (Claude Code, Codex) in auto-approve mode, with filesystem isolation, a filtered Docker socket, and an opt-in outbound firewall.
...
* [mirabilis](https://github.com/AlexShchuka/mirabilis) ⭐ 5 | 🐛 3 | 🌐 Go | 📅 2026-09-01 - One-command launcher that runs Claude Code fully autonomously in an isolated Docker dev container — cross-platform (macOS/Linux/WSL2), with a terminal UI and persistent agent memory.
* [devcontainer-devops](https://github.com/dbhq-uk/devcontainer-devops) ⭐ 2 | 🐛 0 | 🌐 Shell | 📅 2026-08-30 - A DevOps and Infrastructure-as-Code dev container (Terraform, Terragrunt, Azure CLI, Ansible, Kubernetes, PowerShell, .NET) with a `ws` command that opens several repositories as roots of one multi-root workspace in a single container.
* [decolint](https://github.com/bare-devcontainer/decolint) ⭐ 1 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - A linter for Dev Container definitions, Features, and Templates, with checks for correctness, security, and reproducibility.
...
* [C++ image](https://github.com/devcontainers/images/tree/main/src/cpp) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop C++ applications on Linux. Includes Debian C++ build tools (maintained by Microsoft).
...
* [Go image](https://github.com/devcontainers/images/tree/main/src/go) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop Go based applications. Includes appropriate runtime args, Go, common tools, extensions, and dependencies (maintained by Microsoft).
...
* [Java image](https://github.com/devcontainers/images/tree/main/src/java) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop Java applications. Includes the JDK and Java extensions (maintained by Microsoft).
...
* [.NET image](https://github.com/devcontainers/images/tree/main/src/dotnet) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop C# and .NET based applications. Includes all needed SDKs, extensions, and dependencies (maintained by Microsoft).
...
* [Node.js image w/ JavaScript](https://github.com/devcontainers/images/tree/main/src/javascript-node) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop Node.js based applications. Includes Node.js, eslint, nvm, and yarn (maintained by Microsoft).
* [Node.js image w/ TypeScript](https://github.com/devcontainers/images/tree/main/src/typescript-node) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop Node.js based applications in TypeScript. Includes Node.js, eslint, nvm, yarn, and the TypeScript compiler (maintained by Microsoft).
* [Try Out Development Containers: Node.js](https://github.com/microsoft/vscode-remote-try-node) ⭐ 830 | 🐛 28 | 🌐 JavaScript | 📅 2026-07-30 - Node.js sample project for trying out the VS Code Remote - Containers extension (maintained by Microsoft).

### PHP

* [PHP image](https://github.com/devcontainers/images/tree/main/src/php) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop PHP based applications. Includes needed tools, extensions, and dependencies (maintained by Microsoft).
...
* [Python image](https://github.com/devcontainers/images/tree/main/src/python) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop Python 3 applications (maintained by Microsoft).
...
* [Python Project Template](https://github.com/pamelafox/python-project-template) ⭐ 151 | 🐛 3 | 🌐 Python | 📅 2026-07-24: A Dev Container with support for black, isort, ruff, pre-commit, pytest
...
* [SQLAlchemy SQLIte Playground](https://github.com/pamelafox/sqlalchemy-sqlite-playground) ⭐ 8 | 🐛 2 | 🌐 Python | 📅 2024-09-09: Dev Container with SQLAlchemy package, SQLTools extension
* [python 3.10 playground](https://github.com/pamelafox/python-3.10-playground) ⭐ 2 | 🐛 0 | 🌐 Dockerfile | 📅 2022-11-25: A simple 3.10 Dev Container
* [python 3.12 playground](https://github.com/pamelafox/python-3.12-playground) ⭐ 2 | 🐛 0 | 🌐 Dockerfile | 📅 2024-06-13: A simple 3.12 Dev Container

### Ruby

* [Try Out Development Containers: Ruby](https://github.com/devcontainers/images/tree/main/src/ruby) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Ruby sample project for trying out the VS Code Remote - Containers extension (maintained by Microsoft).

### Rust

* [Rust image](https://github.com/devcontainers/images/tree/main/src/rust) ⭐ 2,117 | 🐛 98 | 🌐 Shell | 📅 2026-09-01 - Develop Rust based applications. Includes appropriate runtime args and everything you need to get up and running (maintained by Microsoft).
* [Try Out Development Containers: Rust](https://github.com/microsoft/vscode-remote-try-rust) ⭐ 334 | 🐛 6 | 🌐 Rust | 📅 2024-04-12 - Rust sample project for trying out the VS Code Remote - Containers extension (maintained by Microsoft).
